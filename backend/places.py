...
ALIASES: dict[str, str] = {
    ...
    # The Chornobyl exclusion zone, which these posts name constantly as the
    # way in from Belarus: "через зону відчуження Чорнобильської АЕС". It is
    # an area rather than a town, and Chornobyl itself is the middle of it --
    # near enough for a mark that is about a corridor, and far better than the
    # nothing it resolved to before.
    "Чорнобильська АЕС": "Чорнобиль",
    "Чорнобильської АЕС": "Чорнобиль",
    "зона відчуження": "Чорнобиль",
    "зону відчуження": "Чорнобиль",
    "зоні відчуження": "Чорнобиль",
    "Чернобыль": "Чорнобиль",
    "Chornobyl": "Чорнобиль",
